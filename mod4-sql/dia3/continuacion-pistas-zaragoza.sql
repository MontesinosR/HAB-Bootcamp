...
CREATE TABLE IF NOT EXISTS reservas (
  ...
  FOREIGN KEY (dni_usuario) REFERENCES usuarios (dni) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO usuarios (dni, nombre, telefono, email, apellido)
VALUES ("99888778A", "Lucas", 657264248, "lucas@email.com", "Rodríguez"),
("99288777F", "Marcos", 997263748, "marcos@email.com", "Fernández"),
("99888645F", "Diego", 657262838, "diego@email.com", "Nuñez");

UPDATE usuarios SET telefono = 602827163 WHERE nombre = "Pepe";

DELETE FROM usuarios WHERE nombre = "Lucas";

-- DELETE FROM reservas WHERE dni_usuario = "99888777F";

-- DELETE FROM usuarios WHERE nombre = "Pepe";

UPDATE usuarios SET dni = "49111222F" WHERE nombre = "Pepe";

-- DELETE FROM usuarios WHERE nombre = "Diego" OR nombre = "Marcos";

INSERT INTO usuarios (dni, nombre, telefono, email, apellido) VALUES ("18273612A", "María", 657212328, "maria@email.com", "Gonzalez");

INSERT INTO reservas (fecha_uso, precio, dni_usuario, codigo_pista) VALUES ("2022-05-20 19:00:00", 20, "49111222F", 89273);
INSERT INTO reservas (fecha_uso, precio, dni_usuario, codigo_pista) VALUES ("2022-05-23 16:00:00", 15, "99288777F", 89273);

-- DELETE FROM usuarios WHERE nombre LIKE "M%";

-- DELETE FROM usuarios WHERE nombre IN ("Lucas", "María", "Diego");

-- SELECCIONAR DATOS

SELECT * FROM usuarios ORDER BY nombre ASC;

SELECT * FROM reservas ORDER BY fecha_uso DESC;

SELECT * FROM reservas WHERE fecha_uso BETWEEN "2022-05-15" AND "2022-05-25";

SELECT * FROM reservas WHERE precio BETWEEN 14 AND 18;

SELECT * FROM reservas WHERE fecha_uso BETWEEN "2022-05-15" AND "2022-05-25" AND precio BETWEEN 14 AND 18;

SELECT * FROM reservas ORDER BY precio ASC, id DESC;

SELECT nombre AS Nombre, email Email FROM usuarios;

-- JOIN

SELECT usuarios.email, reservas.fecha_uso, reservas.codigo_pista FROM reservas INNER JOIN usuarios ON reservas.dni_usuario = usuarios.dni;

SELECT * FROM pistas pi INNER JOIN polideportivos po ON pi.id_polideportivo = po.id;